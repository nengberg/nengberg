...
**Staff Engineer · E-commerce Platform & Technical Leadership**  
Stockholm, Sweden · [per.niklas.engberg@gmail.com](mailto:per.niklas.engberg@gmail.com) · [linkedin.com/in/niklasengberg](https://www.linkedin.com/in/niklasengberg)
...
### Volvo Cars · Staff Engineer, Product Offering & Pricing (POP)
`May 2022 – Present` · Stockholm
...
- Led the definition of **Software Eligibility ownership** across Fulfillment and POP clusters, enabling online purchase of software add-ons and establishing clear inter-team accountability where none existed.
...
- Actively mentored engineers on technical growth and more complex project ownership.

`GraphQL / Federated Graph` `Go` `Kubernetes` `OpenTelemetry` `GCP` `Backstage`

---

### Blocket (Schibsted) · Domain Tech Lead → Backend Engineer
`Oct 2019 – Apr 2022` · Stockholm
...
### Santander Consumer Bank · Head of Software Development → Software Architect
`Oct 2017 – Oct 2019` · Stockholm

Dual-role tenure spanning hands-on architecture and people leadership within the Nordic technology organisation.

- As Head of Software Development, led hiring, coaching, and 1:1s for a team of engineers — building capability while maintaining technical credibility.
...
### Creuna · Solution Architect → Developer
`Aug 2012 – Oct 2017` · Stockholm
...
**Bachelor of Science, Computer Science** · Uppsala University · 2009–2012

---

## Core Skills

`Technical leadership` `Cross-team alignment` `System architecture` `GraphQL / Federated Graph` `Go (Golang)` `Kubernetes` `GCP` `OpenTelemetry` `Stakeholder management` `Mentoring & coaching` `E-commerce platforms` `API design`