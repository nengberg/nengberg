...
📍 Stockholm, Sweden &nbsp;·&nbsp; [per.niklas.engberg@gmail.com](mailto:per.niklas.engberg@gmail.com) &nbsp;·&nbsp; [LinkedIn](https://www.linkedin.com/in/niklasengberg)
...
### 🏢 Volvo Cars &nbsp;·&nbsp; Staff Engineer, Offer & Order Engine (OOE)  
...
`Technical leadership` `Cross-team alignment` `System architecture` `GraphQL / Federated Graph` `Go (Golang)` `Kubernetes` `OpenTelemetry` `Stakeholder management` `Mentoring & coaching` `E-commerce platforms` `API design`
